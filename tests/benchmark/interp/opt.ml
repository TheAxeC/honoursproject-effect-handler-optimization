...
let _bigTest_459 = run ((handle { value_clause = (fun _gen_bind_233 ->
                                                     handle { value_clause = (
                                                             fun _y_235 ->
                                                                value (fun _ ->
                                                                value _y_235));
                                                             finally_clause = (
                                                             fun _gen_id_par_234 ->
                                                                value _gen_id_par_234);
                                                             effect_clauses = (fun (type a) (type b) (x : (a, b) effect) ->
             ((match x with | Effect_LookupLoc -> (fun (_x_237 :  loc) (_k_236 :  int -> _ computation) -> value (fun _s_238 ->
                                                                (_lookupState_257
                                                                _x_237) >>
                                                                fun _gen_bind_239 ->
                                                                   (_gen_bind_239
                                                                   ...
                                                                   fun _gen_bind_241 ->
                                                                     _gen_bind_241
                                                                   _s_238)) | Effect_UpdateLoc -> (fun ((
                                                             _x_244, _y_243) : ( loc*
                                                              int)) (_k_242 :  loc -> _ computation) -> value (fun _s_245 ->
                                                                (_k_242
                                                                _x_244) >>
                                                                fun _gen_bind_246 ->
                                                                   ((_updateState_267
                                                                   ...
                                                                   fun _gen_bind_247 ->
                                                                     _gen_bind_246
                                                                   _gen_bind_247)) | Effect_AllocLoc -> (fun (() :  unit) (_k_250 :  loc -> _ computation) -> value (fun _s_251 ->
                                                                (_getNewLoc_288
                                                                _s_251) >>
                                                                fun _gen_bind_252 ->
                                                                   (_k_250
                                                                   ...
                                                                   fun _gen_bind_253 ->
                                                                     _gen_bind_253
                                                                   _s_251)) | eff' -> fun arg k -> Call (eff', arg, k)) : a -> (b -> _ computation) -> _ computation)) } (_gen_bind_233
                                                  []));
                                 finally_clause = (fun _gen_id_par_232 ->
                                                      value _gen_id_par_232);
                                 effect_clauses = (fun (type a) (type b) (x : (a, b) effect) ->
             ((match x with | Effect_LookupLoc -> (fun (_x_255 :  loc) (_k_254 :  int -> _ computation) -> value (fun _s_256 ->
                                    (_lookupState_257 _x_255) >>
                                    fun _gen_bind_257 ->
                                       (_gen_bind_257 _s_256) >>
                                       fun _gen_bind_258 ->
                                          (_k_254 _gen_bind_258) >>
                                          fun _gen_bind_259 ->  _gen_bind_259
                                          _s_256)) | Effect_UpdateLoc -> (fun ((
                                 _x_262, _y_261) : ( loc*
                                  int)) (_k_260 :  loc -> _ computation) -> value (fun _s_263 ->
                                    (_k_260 _x_262) >>
                                    fun _gen_bind_264 ->
                                       ((_updateState_267 _x_262) >>
                                        fun _gen_bind_266 ->
                                           (_gen_bind_266 _y_261) >>
                                           fun _gen_bind_267 ->
                                              _gen_bind_267
                                           _s_263) >>
                                       fun _gen_bind_265 ->  _gen_bind_264
                                       _gen_bind_265)) | Effect_AllocLoc -> (fun (() :  unit) (_k_268 :  loc -> _ computation) -> value (fun _s_269 ->
                                    (_getNewLoc_288 _s_269) >>
                                    fun _gen_bind_270 ->
                                       (_k_268 _gen_bind_270) >>
                                       fun _gen_bind_271 ->  _gen_bind_271
                                       _s_269)) | eff' -> fun arg k -> Call (eff', arg, k)) : a -> (b -> _ computation) -> _ computation)) } (handle {
                         value_clause = (fun _y_221 ->  value (fun _ ->
                                            value _y_221));
                        finally_clause = (fun _gen_id_par_220 ->
                                             value _gen_id_par_220);
                        effect_clauses = (fun (type a) (type b) (x : (a, b) effect) ->
             ((match x with | Effect_InEnv -> (fun ((
                        _env_224, _s_223) : ( env*
                         int)) (_k_222 :  int -> _ computation) -> value (fun _ ->
                           (_k_222 _s_223) >>
                           fun _gen_bind_225 ->  _gen_bind_225 _env_224)) | Effect_ReadEnv -> (fun (() :  unit) (_k_226 :  env -> _ computation) -> value (fun _env_227 ->
                           (_k_226 _env_227) >>
                           fun _gen_bind_228 ->  _gen_bind_228 _env_227)) | Effect_SetEnv -> (fun (_env_230 :  env) (_k_229 :  env -> _ computation) -> value (fun _ ->
                           (_k_229 _env_230) >>
                           fun _gen_bind_231 ->  _gen_bind_231 _env_230)) | eff' -> fun arg k -> Call (eff', arg, k)) : a -> (b -> _ computation) -> _ computation)) } (_interp_339
                        ((Add ((Add ((Add ((Num 1), (Num 2))),
                                     (Add ((Num 1), (Num 2))))),
                               (Add ((Add ((Num 1), (Num 2))),
                                     (Add ((Num 1), (Num 2))))))))))) >>
                        fun _gen_bind_460 ->  _gen_bind_460 [])
